...
import MySQLdb      # mariadb, mysql driver file module import 
...
def myFunc():
    ...
    try:
        ...
        # sql_data = (6, '신상', 11, 5000)          튜플은 가로를 빼도 됌
        ...
        cou = cursor.execute(usql, sql_data)        # return값 
        print('수정 건수: ', cou)
        conn.commit()
        """
        ...
        # cursor.execute(dsql, (code,))                             # (code,) tuple
