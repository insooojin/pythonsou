...
v1 = v2 = v3 = 5
print(v1, v2, v3)
print('출력1', end = ',') # line skip 괄호 안에 있는 문자로 대체
print('출력2')
print('출력3')
...
print(True and False or False)  #and가 or 보다 우선
...
print(bool(0), bool(0.0), bool(''), bool([]), bool(None))       #data가 없으면 false
