...
# func3(80, 180, {'irum' = '신기루', 'nai' = 23})  #SyntaxError: cannot assign to literal here. Maybe you meant '==' instead of '='?
...
def typeFunc(num:int, data:list[str]):      # 가독성
    print(num)
    print(data)
    result = {}
