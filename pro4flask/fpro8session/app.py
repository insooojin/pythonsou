...
# 파이썬 세션(session)은 웹에서 사용자 정보를 서버에 저장하는 기능을 말함(쿠키를 통해 세션을 운영)
# 일정 시간 동안 동일 사용자(브라우저)와 일련의 요청을 하나의 상태로 보고 그 상태를 유지 시키는 기술
# 쿠키에 비해 상대적으로 안전함
...
# adbb9d4e1c70c7401b00efb23f2840be8f42d6112d91e44ce88b2f576dfae3be

app.permanent_session_lifetime = timedelta(seconds=5)   # 세션 만료 시간 5초 설정 (기본은 30분)
